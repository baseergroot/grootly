...
const LoginForm = () => {
    ...
    return (
        ...
        <div className="mb-2">
          ...
          <InputWrapper>
            ...
            <input type="text" id="username" name="username" placeholder="Your username"
              className="border-none outline-none bg-[#1E293B] focus:bg-[#1E293B]" required minLength={3} maxLength={20} />
          </InputWrapper>
        </div>
        <div className="mb-6">
          ...
          <InputWrapper>
            ...
            <input type="password" id="password" name="password" placeholder="Your password"
              className="border-none outline-none bg-[#1E293B]" required minLength={6} maxLength={40} />
          </InputWrapper>
        ...
        <p className="text-center mt-5 text-md">{"Don't have an account? "} <Link href="/signup" className="text-blue-500
          ">Sign Up</Link></p>
      </form>
    )
}
